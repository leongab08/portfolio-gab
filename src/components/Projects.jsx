...
export default function Projects() {
  ...
  return (
    <div
      id="section-projects"
      className="text-white min-h-screen bg-primary-background xl:gap-[300px] xl:flex pt-[120px] py-[10%] px-[6%] xl:px-[2%]"
    >
      <h4 className="text-5xl mb-4 text-center whitespace-nowrap">
        My projects
      </h4>
      <div
